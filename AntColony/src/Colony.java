import java.util.*;
public class Colony {
    private static final int ALPHA = 4; //  Значимость феромона
    private static final int BETA = 1; //  Значимость расстояния
    public static void main(String[] args) {
        List<Dot> dots = Arrays.asList(new Dot(55, 37), new Dot(82, 76), new Dot(81, 82),
                                       new Dot(43, 33), new Dot(52, 41), new Dot(45, 22));
        for (int i = 0; i < 50; i++){
            colony(dots);
        }
    }
